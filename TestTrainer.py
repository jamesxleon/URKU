...
knowledge_base = [
    """¡Imanalla! ¿Imatatak yanapayman?""",
    """Alli puncha! Ñuka shutimi Juan. Ñukaka ishkay chunka watayuk kani, ingeniería yachakukmi kani. Yachaywasipi alli yachakushpami kani. Sumakta yachakunata munani, kay mamallaktapa alli kanapak yanapayta munani.""",
    """"Quiero comer pan" en Kichwa se dice "Tantata mikunata munani".""",
    """En Kichwa, el verbo para "comer" es "mikuna" y para "querer" es "munana".""",
    """Mikuna (comer)\n\nÑuka mikuni (Yo como)\nQam mikunki (Tú comes)\nPay mikun (Él/Ella come)\nÑukanchik mikunchik (Nosotros/as comemos - inclusivo)\nÑukayuk mikuni (Nosotros/as comemos - exclusivo)\nQamkuna mikunkichik (Ustedes comen)\nPaykuna mikun (Ellos/as comen)\nMunana (querer)\n\nÑuka munani (Yo quiero)\nQam munanki (Tú quieres)\nPay munan (Él/Ella quiere)\nÑukanchik munanchik (Nosotros/as queremos - inclusivo)\nÑukayuk munani (Nosotros/as queremos - exclusivo)\nQamkuna munankichik (Ustedes quieren)\nPaykuna munan (Ellos/as quieren)""",
    """Kana - Ser/Estar\nKawsana - Vivir\nYachana - Aprender\nYachakuna - Estudiar\nYachachina - Enseñar\nMikuna - Comer\nPuñuna - Dormir\nPukllana - Jugar\nTushuna - Bailar\nLlamkana - Trabajar\nTiyarina - Sentarse\nHatarina - Levantarse\nTapuna - Preguntar\nKutichina - Responder\nRimana - Hablar\nRurana - Hacer""",
    """Kaymanta willay kani, huk yachak runamanta, payta shutichinakun "Wasiq runa". Kay runa, puñuna waktapi, waktaman rin. Mana alli rimaywan, pay tukuyta rikurin, ñawpakman, ñawpamanmi. Kay runa, mana yachakushkachu imata rurayta waktapi, paylla kawsanakushka. Wasiq runa, pachamamata, sumakta rikushka. Mana tukuy yuyaywan, kay wasiq, yachaymanta yachakushka, ashtawanka, mana allita yachakushka."""
]
